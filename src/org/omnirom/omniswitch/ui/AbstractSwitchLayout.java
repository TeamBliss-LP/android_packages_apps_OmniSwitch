...
public abstract class AbstractSwitchLayout implements ISwitchLayout,
    ...
    protected TimeInterpolator mAccelerateInterpolator = new AccelerateInterpolator();
    protected TimeInterpolator mDecelerateInterpolator = new DecelerateInterpolator();
    ...
    protected abstract LinearLayout.LayoutParams getButtonListParams();
    ...
    protected void buildButtons() {
        ...
        while (nextButton.hasNext()) {
            ...
            mButtonListItems.addView(item, getButtonListParams());
        }
    }
